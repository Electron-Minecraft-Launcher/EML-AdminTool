...
- Added the missing French translation for "Profiles" in the sidebar (thanks to @Loot1).
- Reworked date/time formatter initialization in the dashboard to use a safe locale source with fallback handling (thanks to @Loot1).
